 ...
 *
 * There are multiple configurations for this type of drive.
 *
...
class SwerveDrive : public RobotDriveBase {
 public:
  SwerveDrive(SwerveModule& module, SwerveModules&&... 

  /**
   * All module orientations are independent.
   */
  void SwerveDriveCartesian(double xSpeed, double ySpeed, double zRotation,
                            double gyroAngle = 0.0);

  /**
   * All module orientations are independent.
   */
  void SwerveDrivePolar(double magnitude, double angle, double zRotation);

  /**
   * All module orientations are mechanically linked together.
   */
  void CrabDriveCartesian(double xSpeed, double ySpeed, double zRotation);

  /**
   * All module orientations are mechanically linked together.
   */
  void CrabDrivePolar(double magnitude, double angle, double zRotation);

  /**
   * Front and back module orientations respectively are mechanically linked
   * together.
   */
  void SnakeDriveCartesian(double xSpeed, double zRotation);

  /**
   * Front and back module orientations respectively are mechanically linked
   * together.
   */
  void SnakeDrivePolar();
