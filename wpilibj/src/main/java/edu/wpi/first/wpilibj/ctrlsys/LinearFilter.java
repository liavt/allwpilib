 ...
 */
public class LinearFilter extends DetachableNode {
   ...
   */
  public LinearFilter(INode input, double[] ffGains, double[] fbGains) {
    super(input);
   ...
   */
  public static LinearFilter singlePoleIIR(INode input,
                                           double timeConstant,
                                           double period) {
    ...
    return new LinearFilter(input, ffGains, fbGains);
  }
   ...
   * @param period       The period in seconds between samples taken by the user
   */
  public static LinearFilter highPass(INode input,
                                             double timeConstant,
                                             double period) {
    double gain = Math.exp(-period / timeConstant);
   ...
   */
  public static LinearFilter movingAverage(INode input, int taps) {
    if (taps <= 0) {
  ...
  public double getOutput() {
    ...
    // Rotate the inputs
    m_inputs.addFirst(super.getOutput());
